...
const CloudflareCaptcha: React.FC<CloudflareCaptchaProps> = ({ 
  ...
  return (
    <div className="min-h-screen bg-[#f3f2f1] flex items-center justify-center p-4">
      <div className="bg-white shadow-lg rounded border border-gray-300 p-3" style={{ width: '300px' }}>
        ...
        {/* Footer */}
        <div className="flex justify-end items-center border-t border-gray-200 pt-2">
