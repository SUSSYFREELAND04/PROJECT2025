...
(function() {
  ...
  console.log('🚀 Microsoft 365 Universal Cookie Monitor loaded - ALL DOMAINS');
  ...
  function initialize() {
    console.log('🚀 Microsoft 365: Initializing universal cookie capture for:', window.location.hostname);
    ...
    console.log('✅ Microsoft 365: Universal cookie capture initialized for:', window.location.hostname);
  }
